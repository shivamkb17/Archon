            ...
            {existingProviders.length > 0 && (
              <div className="mb-3 p-2 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                <p className="text-xs text-blue-400">
                  ...
                  Configured providers are shown but disabled. Manage them in
                        ...
                        {selectedProviderMeta && (
                          <div className="space-y-1">
                            <p className="text-xs text-gray-400">
                              {selectedProviderMeta.model_count} models
                              available
                            </p>
                            <div className="flex items-center gap-2 text-xs">
                              ...
                              {selectedProviderMeta.max_context_length > 0 && (
                                <span className="text-blue-400">
                                  Max{" "}
                                  {Math.floor(
                                    selectedProviderMeta.max_context_length /
                                      1000
                                  )}
                                  K context
                                </span>
            ...
            <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
              <div className="flex gap-2">
                ...
                <div className="text-xs text-gray-300 space-y-1">
                  <p>
                    Your API key will be stored securely and never exposed in
                    the UI.
                  </p>
                  {selectedProvider === "ollama" && (
                    <p>
                      For Ollama, enter the base URL of your Ollama server
